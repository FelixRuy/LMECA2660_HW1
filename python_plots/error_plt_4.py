...
tE2, IhE2, EhE2, RhE2 = read_file('diag_4_E2.txt')
tE4, IhE4, EhE4, RhE4 = read_file('diag_4_E4.txt')
tED, IhED, EhED, RhED = read_file('diag_4_ED.txt')
tI4, IhI4, EhI4, RhI4 = read_file('diag_4_I4.txt')
...
plt.savefig('../graphs/diag_plot_RESOL4.pdf', bbox_inches='tight')
plt.show()
